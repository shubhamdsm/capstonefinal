...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="capp_delete_course.php" class="list-group-item active">delete courses</a>
...
?>
  <tbody>
    <tr>
      <td> <input name="checkbox[]" type="checkbox" value="dgg"; </input> </td>
  ...
  <?php } ?>
   ...
   <div class="form-group">
          <button type="submit" id="submit" name="delete" value="Delete" onclick="dele.php" class="btn btn-danger pull-right"> DELETE</button>    
      </div>
